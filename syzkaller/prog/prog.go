...
func (arg ArgCommon) TypeLabel() string {
	switch a := (arg).Type().(type) {
	case *IntType:
		return fmt.Sprintf("IntType_kind=%v", a.Kind)
	case *FlagsType:
		return "FlagsType"
	case *LenType:
		return "LenType"
	...
	case *ProcType:
		return "ProcType"
	case *BufferType:
		return fmt.Sprintf("BufferType_kind=%v_text=%v", a.Kind, a.Text)
	case *ArrayType:
		return fmt.Sprintf("ArrayType_kind=%v", a.Kind)
	case *PtrType:
		return "PtrType"
	case *StructType:
		return "StructType"
	...
	case *ConstType:
		return "ConstType"
	case *CsumType:
		return fmt.Sprintf("CsumType_kind=%v", a.Kind)
	default:
...
func (arg *ConstArg) Label() string {
	labelFields := make([]string, 0)
	labelFields = append(labelFields, arg.TypeLabel())
	labelFields = append(labelFields, fmt.Sprintf("default=%v", isDefault(arg)))
	labelFields = append(labelFields, fmt.Sprintf("optional=%v", arg.Type().Optional()))
	labelFields = append(labelFields, fmt.Sprintf("dir=%v", arg.Dir()))
	return strings.Join(labelFields, "-")
}
...
func (arg *PointerArg) Label() string {
	labelFields := make([]string, 0)
	labelFields = append(labelFields, arg.TypeLabel())
	labelFields = append(labelFields, fmt.Sprintf("default=%v", isDefault(arg)))
	labelFields = append(labelFields, fmt.Sprintf("optional=%v", arg.Type().Optional()))
...
func (arg *GroupArg) Label() string {
	labelFields := make([]string, 0)
	labelFields = append(labelFields, arg.TypeLabel())
	labelFields = append(labelFields, fmt.Sprintf("default=%v", isDefault(arg)))
	labelFields = append(labelFields, fmt.Sprintf("optional=%v", arg.Type().Optional()))
...
func (arg *UnionArg) Label() string {
	labelFields := make([]string, 0)
	labelFields = append(labelFields, arg.TypeLabel())
	labelFields = append(labelFields, fmt.Sprintf("default=%v", isDefault(arg)))
	labelFields = append(labelFields, fmt.Sprintf("optional=%v", arg.Type().Optional()))
...
func (arg *ResultArg) Label() string {
	labelFields := make([]string, 0)
	labelFields = append(labelFields, arg.TypeLabel())
	labelFields = append(labelFields, fmt.Sprintf("default=%v", isDefault(arg)))
	labelFields = append(labelFields, fmt.Sprintf("optional=%v", arg.Type().Optional()))
