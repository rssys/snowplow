...
type Config struct {
	...
	// KernelAnalysis dir that stores the static analysis data
	KernelAnalysisDir string `json:"kernel_analysis"`
	UseML bool `json:"use_ml"`
	MLSmashExecCnt int `json:"mlsmash_exec_cnt"`
	MLServerAddr string `json:"mlserver_addr"`
