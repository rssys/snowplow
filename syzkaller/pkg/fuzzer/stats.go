...
func newStats() Stats {
	return Stats{
		...
		statJobsMLSmash:          stat.New("mlsmash jobs", "Running mlsmash jobs", stat.StackedGraph("jobs")),
		...
		statExecSmash: stat.New("exec smash", "Executions of smashed programs",
			stat.Rate{}, stat.StackedGraph("exec")),
		statExecMLSmash: stat.New("exec mlsmash", "Executions of mlbased smashed programs",
			stat.Rate{}, stat.StackedGraph("exec")),
